...
const Contact = () => {
    return(
        <section id="contact" className="p-6 mt-3 widescreen:section-min-height tallscreen:section-min-height"> 
            ...
            <Form className="max-w-4xl flex flex-col justify-center bg-gray-400 rounded-xl p-6 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 border-4 border-neutral-600 ">
